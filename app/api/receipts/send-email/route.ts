...
export async function POST(request: NextRequest) {
  try {
    ...
    await transporter.sendMail({
      from: process.env.SMTP_FROM || 'noreply@FitFlow-Pro.ru',
      to: receipt.customer.email,
      subject: `Чек FitFlow-Pro №${receiptId}`,
      html: emailHtml,
      attachments: [
        {
  ...
  return `
    ...
    <body>
      ...
      <div class="footer">
        ...
        <p>Если у вас есть вопросы, свяжитесь с нами: support@FitFlow-Pro.ru</p>
      </div>
    </body>
    </html>
  `;
