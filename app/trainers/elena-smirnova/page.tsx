        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center">
              <Link href="/" className="group flex items-center space-x-3">
                ...
                <h2 className="text-xl font-bold text-slate-800 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-blue-500 group-hover:to-green-500 group-hover:bg-clip-text transition-all duration-300">
                  FitFlow Pro
                </h2>
              </Link>
            </div>
            ...
            <Link
              href="/trainers"
              className="flex items-center gap-3 px-6 py-3 h-auto bg-gradient-to-r hover:from-green-100/90 hover:via-white hover:to-green-100/90 border border-none hover:border-blue-300/80 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 ease-out transform hover:scale-105 backdrop-blur-sm"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-12">
          <Card className="overflow-hidden">
            <div
              className={`min-h-64 bg-gradient-to-br ${trainer.gradient} flex items-center justify-center relative p-4`}
            >
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <Button
                          ...
                          onClick={() =>
                            (router.push(`/book-trainer/elena-smirnova?service=${index}`))
                          }
                        >
                          Выбрать
                        </Button>
