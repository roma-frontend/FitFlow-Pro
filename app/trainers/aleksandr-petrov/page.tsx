        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link href="/" className="group flex items-center space-x-3">
              ...
              <h2 className="text-xl font-bold text-slate-800 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-500 group-hover:to-indigo-500 group-hover:bg-clip-text transition-all duration-300">
                FitFlow Pro
              </h2>
            </Link>
            ...
            <Link
              href="/trainers"
              className="flex items-center gap-3 px-6 py-3 h-auto bg-gradient-to-r hover:from-indigo-100/90 hover:via-white hover:to-indigo-100/90 border border-none hover:border-blue-300/80 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 ease-out transform hover:scale-105 backdrop-blur-sm"
            >
