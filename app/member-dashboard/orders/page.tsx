  ...
  return (
    <div className="mb-8">
      ...
      >
        ...
        {/* Иконка дашборда */}
        <LayoutDashboard className="h-5 w-5 text-blue-600 group-hover:text-blue-700 transition-colors duration-200" />
        ...
        <div className="ml-auto opacity-40 group-hover:opacity-60 transition-opacity duration-200">
