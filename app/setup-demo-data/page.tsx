...
export default function SetupDemoDataPage() {
  ...
  const createProducts = async () => {
    const products = [
      ...
      {
        name: "Фитнес-бутылка",
        description: "Спортивная бутылка FitFlow-Pro 750мл",
        ...
        <Card className="mb-8">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              🚀 Настройка демо-данных FitFlow-Pro
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-gray-600 mb-6">
              Этот инструмент создаст тестовые данные для демонстрации всех
              возможностей системы FitFlow-Pro. Будут созданы тренеры, участники,
