// app/page.tsx - Обновленная версия с StaffHomeRedirect
"use client";
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50 w-full overflow-x-hidden">
      <HomeRedirect />
      ...
      {process.env.NODE_ENV === "development" && (
        <div className="w-full bg-yellow-500 text-black p-2 text-center text-sm">
      ...
      {!isDevelopment && !isInstalled && isPWABannerVisible && (
        <div className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white sticky top-0 z-40 shadow-lg">
