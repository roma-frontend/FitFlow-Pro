...
export function PasswordResetLogs() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-0 mb-4 md:mb-0 justify-between">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-0 space-x-2">
              <Button variant="outline" size="sm" onClick={() => fetchLogs()} className="m-0 sm:m-2">
                <RefreshCw className="h-4 w-4 mr-2" />
                Обновить
              </Button>

              <Button variant="outline" size="sm" onClick={handleCleanup} className="m-0 sm:m-2">
