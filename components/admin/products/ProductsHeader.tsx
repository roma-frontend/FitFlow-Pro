...
export function ProductsHeader({
  ...
  return (
    <header className="relative bg-gradient-to-r from-white via-gray-50 to-white border-b border-gray-200/80 backdrop-blur-sm mb-4 rounded-xl">
      {/* Декоративная линия */}
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-start sm:items-center gap-3 sm:gap-4 min-w-0 flex-1">
            ...
            {showBackButton && onBack && (
              <button
                onClick={onBack}
                className="hidden sm:block group p-2 hover:bg-purple-50 rounded-xl transition-all duration-200 sm:hidden transform hover:scale-105 active:scale-95"
                aria-label="Назад"
              >
            ...
            >
              <h1 className={`text-lg sm:text-xl lg:text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent transition-all duration-300 ${
