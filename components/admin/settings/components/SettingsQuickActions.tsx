...
interface QuickAction {
  ...
  action: () => void;
  variant: "primary" | "secondary" | "destructive" | "badge"; // ✅ Добавлен тип badge
  disabled?: boolean;
  badge?: string;
  description?: string;
}
...
export const SettingsQuickActions = ({
  ...
  const router = useRouter(); // ✅ Добавлен роутер
                  ...
                  action.variant === "primary"
                    ...
                    : action.variant === "destructive"
                      ...
                      : action.variant === "badge"
                        ? "outline" // ✅ Стиль для badge кнопки
                        : "outline"
                }
                ...
                <div className="flex items-center gap-2">
                  <Icon
                    className={cn(
                      ...
                      action.variant === "badge" && "text-purple-600" // ✅ Цвет иконки Badge
                    )}
                  />
                  <span
                    className={cn(
