          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <div className="relative">
                <Search className="absolute left-[10px] top-[20px] transform -translate-y-1/2 text-gray-400 h-4 w-4" />
                <Input
        ...
        <CardContent>
          <div className="space-y-4">
            {filteredUsers.map(user => {
              ...
              return (
                <div key={user.id} className="flex items-center justify-between flex-wrap gap-3 p-4 border rounded-lg">
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input type="email" placeholder="user@FitFlow-Pro.ru" />
            </div>
