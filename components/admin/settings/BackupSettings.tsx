        ...
        <CardContent>
          <div className="space-y-3">
            {backups.map(backup => {
              ...
              return (
                <div key={backup.id} className="flex flex-wrap gap-4 items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600 flex items-center gap-4">
                        ...
                        <Badge variant="custom" className={backup.type === 'auto' ? 'bg-blue-50' : 'bg-purple-50'}>
