...
const CartButton = memo(() => {
  ...
  if (!isHydrated) {
    return (
      <Button 
        variant="outline" 
        className="bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 relative bg-white/90 backdrop-blur-sm border-white/20 text-gray-700 hover:bg-white"
  ...
  return (
    <Button
      ...
      className={`relative transition-all duration-200 ${
        hasItems 
          ? 'bg-gradient-to-r from-blue-500 to-indigo-500 text-white border-blue-600 hover:from-blue-600 hover:to-indigo-600 shadow-lg' 
