                  ...
                  {week.map((day, dayIndex) => (
                    <div
                      ...
                      className={`
                        ...
                        ${day.isToday ? 'bg-gradient-to-r from-blue-500 to-indigo-500 text-white' : ''}
                        ${day.isSelected && !day.isToday ? 'bg-gradient-to-r from-blue-500 to-indigo-500  border-blue-500' : ''}
          ...
          <CardContent>
            {selectedDateWorkouts.length > 0 ? (
              ...
              <div className="text-center py-8">
                ...
                <Button size="sm" onClick={() => setShowAddWorkout(true)} className='bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600'>
          ...
          <div className="grid grid-cols-7 gap-4">
            {['Пн', 'Вт', 'Ср', 'Чт', 'Пт', 'Сб', 'Вс'].map((day, index) => {
              const dayWorkouts = workouts.filter(w => {
                ...
                const adjustedDay = workoutDay === 0 ? 6 : workoutDay - 1;
                ...
                <div key={day} className="text-center">
                  <div className="mb-2">
                    <div className="h-32 bg-gray-200 rounded-lg relative overflow-hidden">
                      <div 
                        className="absolute bottom-0 left-0 right-0 bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 transition-all duration-500"
