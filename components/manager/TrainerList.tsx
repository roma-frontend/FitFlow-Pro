      ...
      <CardContent>
        <div className="space-y-4">
          {trainers.slice(0, 5).map((trainer) => (
            <div
              key={trainer.id}
              className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-0 justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-200"
            >
