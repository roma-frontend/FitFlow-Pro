        ...
        <div className="flex flex-col h-full">
          ...
          <div className="border-t border-gray-200 p-4">
            <div 
              ...
              style={{
                transitionDelay: isOpen ? `${(navigationItems.length + 3) * 50}ms` : '0ms'
              }}
            >
            ...
            <div className="mt-3 space-y-2">
              {[
                ...
                { icon: LogOut, label: 'Выйти', href: null, action: handleLogout, danger: true }
              ].map((item, index) => {
                const IconComponent = item.icon;
                return (
                  <div
                    ...
                    style={{
                      transitionDelay: isOpen ? `${(navigationItems.length + 4 + index) * 50}ms` : '0ms'
                    }}
                  >
                    <Button
                      variant="ghost"
