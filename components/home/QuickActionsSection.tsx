...
export default function QuickActionsSection({ authStatus, onDashboardRedirect }: QuickActionsSectionProps) {
  ...
  return (
    <div className="mb-16">
      <Card className="bg-gradient-to-r from-green-50 to-blue-50 border-2 border-dashed border-blue-300 rounded-2xl">
        <CardHeader>
          <CardTitle className="flex items-center gap-3 text-center justify-center text-2xl">
            <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 rounded-lg flex items-center justify-center">
