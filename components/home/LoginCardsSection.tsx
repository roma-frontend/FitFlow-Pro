...
export default function LoginCardsSection() {
  ...
  return (
    <div className="hidden md:grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
      <Card className="hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 bg-gradient-to-br from-blue-50 to-indigo-100 border-blue-200">
        <CardContent className="p-8 text-center">
          ...
          <Button
            ...
            className="w-full bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 transition-all duration-300 hover:scale-105 rounded-xl py-3"
          >
            Войти как участник
          </Button>
        </CardContent>
